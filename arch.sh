...
configure_system() {
    ...
    echo "192.168.31.21:/ /home/$USERNAME/data nfs4 _netdev,noauto,x-systemd.automount,x-systemd.mount-timeout=10,timeo=14,rsize=1048576,wsize=1048576 0 0" >> /etc/fstab
